...
可改写为Loon复写：
[Script] 
http-request ^https?:\/\/httpbin\.org script-path = https://raw.githubusercontent.com/luestr/ProxyToolbox/main/Resource/Script/CommonScript/replace-header.js, argument=(\r\n)User-Agent:.+(\r\n)->$1User-Agent: Chrome/71.0.3578.98 Safari/537.36$2, tag = 替换UA
http-response ^https?:\/\/httpbin\.org script-path = https://raw.githubusercontent.com/luestr/ProxyToolbox/main/Resource/Script/CommonScript/replace-header.js, argument=(\r\n)Content-Type:.+(\r\n)->$1Content-Type: text/plain; charset=UTF-8$2, tag = 替换UA
